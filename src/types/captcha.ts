...
export const CaptchaStatusSchema = z.enum(['Pending', 'Approved', 'Disapproved'])
export const CaptchaStatusZod = CaptchaStatusSchema.Values
export type CaptchaStatusZod = z.infer<typeof CaptchaStatusSchema>;
